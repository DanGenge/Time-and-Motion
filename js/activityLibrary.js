...
// Each activity carries a suggested `bucket` (workflow group) and a
// `group` (accountability report group used to pick its category badge).
// ============================================================
...
// fallback labels/colours for the 4 reporting groups (used by Reports)
